...
export const translations = {
  en: {
    ...
    labels: {
      ...
      headCovering: "Head Covering (if applicable)",
      smoking: "Smoking",
      hobbies: "Hobbies",
      ...
      preferredLearningStatus: "Preferred Learning Status",
    ...
    placeholders: {
      ...
      selectLearningStatus: "Select preferred learning status...",
  ...
  he: {
    ...
    labels: {
      ...
      learningStatus: "סטטוס לימודים",
      headCovering: "כיסוי ראש (אם רלוונטי)",
      smoking: "עישון",
      hobbies: "תחביבים",
      ...
      preferredLearningStatus: "סטטוס לימודים מועדף",
    ...
    placeholders: {
      ...
      selectLearningStatus: "בחר סטטוס לימודים מועדף...",
    ...
    options: {
      ...
      religiousAffiliation: [
        ...
        { value: "Modern Orthodox", label: "דתי מודרני" },
