...
export const translations = {
  en: {
    ...
    labels: {
      ...
      learningStatus: "What is your learning status?",
      headCovering: "How will you cover your hair once married?",
    ...
    options: {
      ...
      religiousAffiliation: [
        ...
        { value: "Baal Teshuva", label: "Baal Teshuva" },
      ...
      learningStatus: [
        ...
        { value: "Learn then Work", label: "Learn then Work" },
  ...
  he: {
    ...
    labels: {
      ...
      learningStatus: "מה סטטוס הלימוד שלך?",
      headCovering: "איך תכסי את השיער לאחר הנישואין?",
    ...
    options: {
      ...
      religiousAffiliation: [
        ...
        { value: "Baal Teshuva", label: "חוזר בתשובה" },
      ...
      learningStatus: [
        ...
        { value: "Learn then Work", label: "ללמוד בהתחלה ואז שילוב עבודה" },
