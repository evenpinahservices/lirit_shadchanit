...
export const translations = {
  en: {
    ...
    labels: {
      ...
      learningStatus: "What is your current learning status?",
      headCovering: "How do you plan on covering your head once you are married?",
      ...
      preferredLearningStatus: "What learning status do you want in your husband?",
      preferredHeadCovering: "How do you want your wife to cover her hair?",
  ...
  he: {
    ...
    labels: {
      ...
      learningStatus: "מה סטטוס הלימוד תורה שלך כרגע?",
      headCovering: "איך את מתכננת לכסות את ראשך לאחר הנישואין?",
      ...
      preferredLearningStatus: "איזה סטטוס לימוד תורה את מחפשת בבעל?",
      preferredHeadCovering: "איך אתה רוצה שאשתך תכסה את שערה?",
