# Bug Reports (Main Database)

## 1. Toolbar visible in login
- **ID**: 69415a11903a64f9cb5cf476
- **Page**: /login
...
## 3. not utilising space - too squashed
- **ID**: 69426d638c46b4466cee968a
- **Page**: /search
- **User**: Lirit Adam (admin)
...
## 4. make side panel until left margin and have dynamic reults displayed on the right. no search button required
- **ID**: 69426da88c46b4466cee968c
- **Page**: /search
- **User**: Lirit Adam (admin)
...
## 5. should be wider and with margin
- **ID**: 69426dcd2c23bbf020e8c14f
- **Page**: /clients/new
- **User**: Lirit Adam (admin)
...
## 9. A lot of people give hebrew dob, there needs to be an option of loazi or ivri dob
- **ID**: 694be923991e3a34e3f719f4
- **Page**: /clients/new
- **User**: Lirit Adam (admin)
...
## 10. There r people who just give year dob, dint want to be exact for some reason, needs to be an option for that
- **ID**: 694bed2e256ef470786df2c4
- **Page**: /clients/new
- **User**: Lirit Adam (admin)
...
## 11. Where do i specify the עדה?
- **ID**: 694beddb256ef470786df2c6
- **Page**: /clients/new
- **User**: Lirit Adam (admin)
...
## 12. What if i want to send the resume to a guy but want the pic to disappear?
- **ID**: 694bf49b994e454ee7dc2530
- **Page**: /clients
- **User**: Lirit Adam (admin)
...
## 13. Failed to upload pic
- **ID**: 694c03b4197738c63c7aadf2
- **Page**: /clients/new
- **User**: Lirit Adam (admin)
...
## 15. date should auto link, update logic to support hebrew
- **ID**: 6952f4ea7e8f3346d300225c
- **Page**: /clients/694c0456197738c63c7aadf4
- **User**: Lirit Adam (admin)
...
## 16. this doesnt show up in the profile overview. add support for hebrew location
- **ID**: 6952f5227e8f3346d300225e
- **Page**: /clients/694c0456197738c63c7aadf4
- **User**: Lirit Adam (admin)
...
## 17. Can we have the Jewish calendar with Hebrew letters and not numbers?
- **ID**: 6954333961d74fabacaaf671
- **Page**: /clients/new
- **User**: Lirit Adam (admin)
...
## 18. This is already a few in a row that I am unable to upload a pic...
- **ID**: 695433c8f8c2f90b8080af9d
- **Page**: /clients/new
- **User**: Lirit Adam (admin)
...
## 19. Hiw do i sendnpics to clients? And I need them to be disappearing
- **ID**: 6954fac176d90bcdd558ade9
- **Page**: /clients/694bebd9256ef470786df2c1
- **User**: Lirit Adam (admin)
...
## 20. Auto full screen feature
- **ID**: 695ac8a80173549d2c8d0597
- **Page**: /search
- **User**: Lirit Adam (admin)
...
## 21. Open menu overlay
- **ID**: 695acb1871c50ffae6ed5643
- **Page**: /clients/new
- **User**: Lirit Adam (admin)
...
## 22. Have to erase name to search again
- **ID**: 695acd9d9ee30fcaaf8571e7
- **Page**: /matching
- **User**: Lirit Adam (admin)
...
## 23. Dynamic view port
- **ID**: 695ace1d9ee30fcaaf8571e9
- **Page**: /search
- **User**: Lirit Adam (admin)
...
## 33. Swipe support on profile section
Content doesn't scroll down enough so bottom of text is hedden
- **ID**: 6973665f24d5a525338c06a2
- **Page**: /clients/696bed771009a161a4c45646
- **User**: Lirit Adam (admin)
- **Date**: 1/23/2026, 2:15:23 PM
- **Status**: new
- **Screenshot**: ![Screenshot](https://res.cloudinary.com/ddk38gj1w/image/upload/v1769170526/bug-reports/jmwia2nnpnvbr2o9lcmb.png)

---

## 34. Responsive generate form link
- **ID**: 69736681ea4113e693a62c5a
- **Page**: /inbox
- **User**: Lirit Adam (admin)
- **Date**: 1/23/2026, 2:15:58 PM
- **Status**: new
- **Screenshot**: ![Screenshot](https://res.cloudinary.com/ddk38gj1w/image/upload/v1769170561/bug-reports/lev1fjc1dxwhachmeojj.png)

---

## 35. Form overlaps background
- **ID**: 697368a4ea4113e693a62c6d
- **Page**: /clients
- **User**: Lirit Adam (admin)
- **Date**: 1/23/2026, 2:25:07 PM
- **Status**: new
- **Screenshot**: ![Screenshot](https://res.cloudinary.com/ddk38gj1w/image/upload/v1769171107/bug-reports/nvvfois7xw6xao2wu8jj.png)

---

## 36. Keyboard opens and hides text freeilds
- **ID**: 697368c3ea4113e693a62c6f
- **Page**: /clients
- **User**: Lirit Adam (admin)
- **Date**: 1/23/2026, 2:25:37 PM
- **Status**: new
- **Screenshot**: ![Screenshot](https://res.cloudinary.com/ddk38gj1w/image/upload/v1769171138/bug-reports/badb4pshast8v7jxf0au.png)

---

## 37. Default is 5 and display is too large
- **ID**: 697368e7ea4113e693a62c71
- **Page**: /search
- **User**: Lirit Adam (admin)
- **Date**: 1/23/2026, 2:26:14 PM
- **Status**: new
- **Screenshot**: ![Screenshot](https://res.cloudinary.com/ddk38gj1w/image/upload/v1769171175/bug-reports/nvxxxqexyml19sjq2ql6.png)
