...
export function ClientForm({ client, isEditing = false, onCancel }: ClientFormProps) {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 pb-24 md:pb-0">
            {/* Wizard Header */}
            <div className="bg-white dark:bg-gray-950 p-4 rounded-xl border shadow-sm sticky top-0 z-30">
            ...
            {/* Steps Content */}
            <div className="bg-white dark:bg-gray-950 p-6 rounded-xl border shadow-sm space-y-6 min-h-[50vh]">
            ...
            {/* Footer Navigation */}
            <div className="fixed bottom-0 md:static left-0 right-0 p-4 bg-white dark:bg-gray-950 border-t z-40 flex items-center justify-between pb-[env(safe-area-inset-bottom)]">
