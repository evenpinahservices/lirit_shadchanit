    ...
    return (
        <div className="flex flex-col h-full overflow-hidden space-y-4">
            ...
            <div className="flex-1 flex flex-col min-h-0 overflow-hidden pb-24 md:pb-0">
                ...
                {/* ── DISCOVER TAB ── */}
                <div className={cn("flex-1 min-h-0 overflow-y-auto custom-scrollbar px-1 pb-4", tab !== "discover" && "hidden")}>
                        {clientsLoading ? (
                            <div className="flex flex-col items-center justify-center py-16 text-gray-400">
                                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-red-600 mb-4" />
                ...
                {/* ── SEARCH TAB ── */}
                <div className={cn("flex flex-col gap-4 h-full min-h-0 overflow-hidden flex-1", tab !== "search" && "hidden")}>
