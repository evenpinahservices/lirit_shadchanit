...
export const translations = {
  en: {
    ...
    labels: {
      ...
      learningStatus: "Learning Torah Status",
      headCovering: "Head Covering Once Married (if applicable)",
      ...
      preferredLearningStatus: "Preferred Learning Torah Status",
      preferredHeadCovering: "Preferred Head Covering",
    ...
    placeholders: {
      ...
      occupation: "e.g. Teacher, Developer",
      ...
      selectLearningStatus: "Select preferred learning Torah status...",
      selectHeadCovering: "Select preferred head covering...",
    ...
    profileView: {
      ...
      learningStatus: "Learning Torah Status",
      headCovering: "Head Covering Once Married",
      smoking: "Do you smoke?",
      hobbies: "Hobbies",
      education: "Education",
      occupation: "Occupation",
  ...
  he: {
    ...
    labels: {
      ...
      preferredLearningStatus: "סטטוס לימוד תורה מועדף",
      preferredHeadCovering: "כיסוי ראש מועדף",
    ...
    placeholders: {
      ...
      selectLearningStatus: "בחר סטטוס לימוד תורה מועדף...",
      selectHeadCovering: "בחר כיסוי ראש מועדף...",
    ...
    profileView: {
      ...
      headCovering: "כיסוי ראש לאחר נישואין",
      smoking: "האם אתה מעשן?",
      hobbies: "תחביבים",
      education: "השכלה",
      occupation: "עיסוק",
